...
Computer scientist with a Master's in Artificial Intelligence and a Bachelor's in Computer Science, focused on large language models. My thesis [DeltaAttention](https://emruur.github.io/DeltaAttention/) coveres sparse attention for long-context optimization, implemented down to custom CUDA/Triton kernels. I've also surveyed the literature on LLM interpretability, the study of how these models work internally. During an internship I built [SmartQA](https://github.com/Emruur/SmartQA), a full-stack information-retrieval pipeline powering a lightweight, hallucination-resistant chatbot.
